...
.http-response
include::{snippets}/match-password/http-response.adoc[]
...
.curl-request
include::{snippets}/post-club-memberReport/curl-request.adoc[]

.http-request
include::{snippets}/post-club-memberReport/http-request.adoc[]

.path-parameters
include::{snippets}/post-club-memberReport/path-parameters.adoc[]

.request-headers
include::{snippets}/post-club-memberReport/request-headers.adoc[]

.request-fields
include::{snippets}/post-club-memberReport/request-fields.adoc[]

.http-response
include::{snippets}/post-club-memberReport/http-response.adoc[]

.response-fields
include::{snippets}/post-club-memberReport/response-fields.adoc[]
