...
.request-headers
include::{snippets}/post-follow/request-headers.adoc[]
...
.curl-request
include::{snippets}/post-unfollow/curl-request.adoc[]

.http-request
include::{snippets}/post-unfollow/http-request.adoc[]

.path-parameters
include::{snippets}/post-unfollow/path-parameters.adoc[]

.request-headers
include::{snippets}/post-unfollow/request-headers.adoc[]

.http-response
include::{snippets}/post-unfollow/http-response.adoc[]

=== 나를 팔로우한 회원 리스트 조회

.curl-request
include::{snippets}/get-followers/curl-request.adoc[]
...
.curl-request
include::{snippets}/get-followings/curl-request.adoc[]
...
.curl-request
include::{snippets}/get-follow-status/curl-request.adoc[]

.http-request
include::{snippets}/get-follow-status/http-request.adoc[]

.path-parameters
include::{snippets}/get-follow-status/path-parameters.adoc[]

.request-headers
include::{snippets}/get-follow-status/request-headers.adoc[]

.http-response
include::{snippets}/get-follow-status/http-response.adoc[]

.response-fields
include::{snippets}/get-follow-status/response-fields.adoc[]

=== 강제 팔로우 해제

.curl-request
include::{snippets}/delete-followers/curl-request.adoc[]

.http-request
include::{snippets}/delete-followers/http-request.adoc[]

.path-parameters
include::{snippets}/delete-followers/path-parameters.adoc[]

.request-headers
include::{snippets}/delete-followers/request-headers.adoc[]

.http-response
include::{snippets}/delete-followers/http-response.adoc[]
