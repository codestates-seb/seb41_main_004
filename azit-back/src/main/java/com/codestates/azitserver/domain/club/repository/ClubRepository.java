...
public interface ClubRepository extends JpaRepository<Club, Long> {
	...
	// SELECT * FROM CLUB WHERE MEETING_DATE BETWEEN {시작} AND {끝}
	@Query("select c from Club c where c.meetingDate between :targetDateBefore and :targetDate")
	Page<Club> findAllClubsByClubMeetingDate(LocalDateTime targetDateBefore, LocalDateTime targetDate,
		PageRequest createdAt);
