...
-- TEST USER
INSERT INTO MEMBER (EMAIL, PASSWORD, NICKNAME, MEMBER_STATUS, BIRTH_YEAR, REPUTATION) VALUES ('admin_test@hello.com', '{bcrypt}$2a$10$VG83rqZddIfFCzHu4zCIwulurZs4xUED/dLnnFdbiyHodunY8pDyC', 'admin_test', 'ACTIVE', 2000, 10);
INSERT INTO MEMBER (EMAIL, PASSWORD, NICKNAME, MEMBER_STATUS, BIRTH_YEAR, REPUTATION) VALUES ('user_test@hello.com', '{bcrypt}$2a$10$VG83rqZddIfFCzHu4zCIwulurZs4xUED/dLnnFdbiyHodunY8pDyC', 'user_test', 'ACTIVE', 2000, 10);
